...
export const AuthMessages = {
	...
	FAILED_TO_REGISTER_USER: 'Failed to register user, Please Check the fields!',
	EMPTY_EMAIL_OR_PASSWORD: 'Please provide Email and Password',
	INVALID_EMAIL_OR_PASSWORD: 'Invalid email or password',
	USER_LOGGED_IN_SUCCESSFULLY: 'User logged in successfully',
	INACTIVE_USER: 'Not an active user, Please Wait for Admin Approval',
	REJECTED_USER: 'User registration rejected by admin',
	...
	INVALID_AZURE_TOKEN: 'Invalid Azure Token'
};
...
export const PostGreSqlDbMessages = {
	...
	TRY_AGAIN_MESSAGE: 'Are you sure about the query?',
};
