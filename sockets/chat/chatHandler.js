  ...
  try {
    ...
    switch (botProvider) {
      case "openai":
        ...
        ({ stream, model } = await chatService.generateOpenAiStreamResponse({
          prompt: userPrompt,
          chatLog,
        }));
      ...
      case "gemini":
        ...
        ({ stream, model } = await chatService.generateGeminiAIStreamResponse({
          prompt: userPrompt,
          chatLog,
        }));
      ...
      case "claude":
        ...
        ({ stream, model } = await chatService.generateClaudeAiStreamResponse({
          prompt: userPrompt,
          chatLog,
        }));
